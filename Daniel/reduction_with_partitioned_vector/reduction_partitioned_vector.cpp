...
int hpx_main(hpx::program_options::variables_map& vm)
{
    ...
    if (vm.count("maxelems"))
        size = vm["maxelems"].as<unsigned int>();
   ...
   std::cout << "using vector size: " << size << std::endl;
 ...
 
    {
        ...
        hpx::partitioned_vector<int> sums_per_locality;
        ...
        if (0 == hpx::get_locality_id())
        {
            ...
            sums_per_locality = hpx::partitioned_vector<int>(localities.size(), hpx::container_layout(localities));
        ...
        partitioned_vector_view<int> view2(sums_per_locality);

        double result = hpx::reduce(hpx::execution::par, view1.begin() , view1.end());
        ...
        if (0 == hpx::get_locality_id())
        {
            double result = hpx::reduce(hpx::execution::par, sums_per_locality.begin() , sums_per_locality.end());
