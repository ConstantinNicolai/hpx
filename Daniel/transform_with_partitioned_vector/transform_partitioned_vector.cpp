...
int hpx_main(hpx::program_options::variables_map& vm)
{
...

    {
        ...
        partitioned_vector_view<int> view_v(v);
        ...
        */
        ...
        partitioned_vector_view<int> view_y(y);
